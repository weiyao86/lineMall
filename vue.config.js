...
module.exports = {
  publicPath: process.env.NODE_ENV === "production" ? "/wx/" : "/", // 公共路径
  ...
  devServer: {
    ...
    hotOnly: true, // 热更新
    historyApiFallback: true, //需要服务端配合
    // proxy: 'http://localhost:8080'   // 配置跨域处理,只有一个代理
    proxy: {
      //配置多个跨域
      "/api": {
        target: "http://zgwjapi.xinyingtong.cn/", // "http://zgwjapi.xinyingtong.cn/",// "http://172.16.30.234/",
        changeOrigin: true,
        // ws: true, //websocket支持
        secure: false,
        pathRewrite: {
